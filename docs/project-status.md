...
- 2,065 条记录已经按结构身份做互斥分类：已确认残基 114 条、在 PDB 聚合物中出现但单体资料待补 162 条、特殊用途／结构参考 294 条、氨基酸样待确认候选 1,266 条、非单体／明确排除 229 条；五类合计 2,065，不重复计数。
...
- 162条“PDB中出现”记录已完成代表PDB标题语境初筛：26条直接环肽／宏环线索、6条混合语境、4条其他约束肽线索、2条明确线性线索、124条仅凭标题不能判断。该结果是机器排序线索，不是环化拓扑人工确认。
- 1,266条待确认候选已完成结构字段二次分层：954条较像独立偶联单体、53条特殊反应基团候选、5条强非普通单体信号、254条信息不足；结果不推定供应、SPPS/LPPS或环肽使用成立。
...
2. 优先核查954条“较像独立单体”候选中的保护形式、供应或公开合成路线，再决定是否升级为可用单体。

...
export const patentTierByEnglish: Record<string, PatentTier> = {
  "D-Ile": "D2",
  "D-Phe": "D2",
  "trans-4-F-Pro · (2S,4S)-4-fluoroproline": "D2",
...
const specificGuides: Record<string, DesignGuide> = {
  ...
  "trans-4-F-Pro · (2S,4S)-4-fluoroproline": { replace: "L-Pro；与Pro、cis-4-F-Pro成组比较", goal: "微调脯氨酸环折叠、肽键平衡和代谢稳定性", avoid: "没有构象依据时把氟化直接当作增渗手段" },
  ...
  "5-F-Trp · 5-fluoro-L-tryptophan": { replace: "Trp", goal: "微调吲哚电子性质、结合几何和氧化代谢位点", avoid: "把氟化本身视为必然增渗，或空间极度受限的位置" },
  ...
  "CMO-Pro · (3S)-3-(carboxymethoxy)-L-proline": { replace: "Pro或需要极性交联把手的转角位", goal: "同时获得Pro式约束、增溶位点和分子内连接能力", avoid: "羧酸暴露于膜环境且无法被交联或内部遮蔽的位置" },
  ...
  "4-CF₃-Hph · 4-(trifluoromethyl)-homophenylalanine": { replace: "Phe／Hph，且靶点存在较深疏水口袋的位置", goal: "同时改变芳环距离、强疏水占位和代谢稳定性", avoid: "水溶性已低、口袋浅或无法容忍侧链延长的位置" },
...
export const experimentData: Record<string, ExperimentDatum> = {
  ...
  "4-CF₃-Hph · 4-(trifluoromethyl)-homophenylalanine": { comparison: "AP0343第7位Phe(3-Cl)→Hph(4-CF₃)", endpoint: "结合／细胞活性及构象", result: "活性提高并保持主链构象", system: "KRAS结合、细胞与晶体结构", formulation: "收益包含靶点诱导契合，非单纯增渗" },
  ...
  "thioamide substitution": { comparison: "单个C=O→C=S与母体", endpoint: "口服血浆暴露", result: "优选类似物约提高30、130或400倍", system: "疏水环六肽；动物口服", formulation: "未使用增渗微乳制剂" },
};
